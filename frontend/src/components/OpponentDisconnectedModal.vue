<template>
    <div ref="opponentDisconnectedModal" id="hs-opponentDisconnectedModal"
         class="[--overlay-backdrop:static] hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
