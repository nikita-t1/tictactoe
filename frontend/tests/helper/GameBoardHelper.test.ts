...
import { EMPTY_BOARD_FIELD, MOVE_BY_PLAYER, MOVE_BY_COMPUTER, winConditions, checkDraw, checkWinner } from "../../src/helper/GameBoardHelper";
...
test('checkDraw correctly identifies draw', ({ expect }) => {
    const fullBoard = [
        MOVE_BY_PLAYER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER,
        MOVE_BY_COMPUTER, MOVE_BY_PLAYER, MOVE_BY_COMPUTER,
        MOVE_BY_PLAYER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER
    ]
...
test('checkDraw correctly identifies not a draw', ({ expect }) => {
    const notFullBoard = [
        MOVE_BY_PLAYER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER,
        MOVE_BY_COMPUTER, MOVE_BY_PLAYER, EMPTY_BOARD_FIELD,
        MOVE_BY_PLAYER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER
    ]
...
test('checkWinner correctly identifies player as winner', ({ expect }) => {
    const winningPlayerBoard = [
        ...
        MOVE_BY_COMPUTER, EMPTY_BOARD_FIELD, MOVE_BY_COMPUTER,
        EMPTY_BOARD_FIELD, MOVE_BY_COMPUTER, EMPTY_BOARD_FIELD
    ]
...
test('checkWinner correctly identifies opponent as winner', ({ expect }) => {
    const winningComputerBoard = [
        MOVE_BY_COMPUTER, MOVE_BY_PLAYER, MOVE_BY_PLAYER,
        MOVE_BY_COMPUTER, MOVE_BY_PLAYER, MOVE_BY_PLAYER,
        MOVE_BY_COMPUTER, EMPTY_BOARD_FIELD, EMPTY_BOARD_FIELD
    ]
    expect(checkWinner(winningComputerBoard)).toBe(MOVE_BY_COMPUTER)
})

test('checkWinner correctly identifies a draw', ({ expect }) => {
    const drawBoard = [
        MOVE_BY_PLAYER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER,
        MOVE_BY_COMPUTER, MOVE_BY_COMPUTER, MOVE_BY_PLAYER,
        MOVE_BY_PLAYER, MOVE_BY_PLAYER, MOVE_BY_COMPUTER
    ]
